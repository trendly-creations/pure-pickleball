...
$class 		=	(sh_set($settings, 'tag_sidebar'))? 'col-md-8' : 'col-md-12';
$sidebar 	=	sh_set($settings, 'tag_sidebar');
$layout 	=	sh_set($settings, 'tag_layout');
$title 		=	sh_set($settings, 'tag_heading');
$icon 		=	sh_set($settings, 'tag_title_icon');
$blog_style	=	sh_set($settings, 'tag_blog_style');
$inner_cls	=	(sh_set($settings, 'tag_sidebar'))? 'col-md-6' : 'col-md-4';
$ext 		= 	explode( ' ', $title, 2 );
?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="<?php echo $class;?>">
					<?php if( sh_set( $settings, 'tag_show_heading' ) == 1 ): ?>
					<div class="heading1">
						<h1><?php if( $icon ):?><i class="<?php echo $icon?>"></i><?php endif; ?> <strong><?php echo sh_set( $ext, '0' )?></strong> <?php echo sh_set( $ext, '1' )?> <?php echo $queried_object->name;?></h1>
					</div>
					<?php endif; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="blog-list-desc">
                                            ...
                                            <ul class="plan-metas">
                                                <li><i class="fa fa-user"></i> <?php _e( 'By:', SH_NAME )?> <a href="<?php echo get_tag_posts_url( get_the_tag_meta( 'ID' ) ); ?>" title=""> <?php ucwords( the_tag_meta( 'display_name' ) ); ?></a> </li>
