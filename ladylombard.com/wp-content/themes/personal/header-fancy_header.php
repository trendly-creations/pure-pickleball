...
<div class="theme-layout <?php echo $boxed?>">
		...
		<header class="header-style4 <?php echo $sticky;?>">
        	<div class="logo">
				<?php $Logo = '<img src="' . sh_set( $settings, 'logo_image' ) . '" alt="" />'; ?>
                <a href="<?php echo home_url(); ?>" title="<?php bloginfo('name'); ?>"><?php if(sh_set( $settings, 'logo_image' )){ echo $Logo;}else{ bloginfo('name'); }; ?></a>
            </div>
            <div class="menu-sec">
                <div class="container">                    
                    <nav class="menus">
