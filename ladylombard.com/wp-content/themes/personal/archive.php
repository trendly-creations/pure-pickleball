...
$class 		=	(sh_set($settings, 'archive_sidebar'))? 'col-md-8' : 'col-md-12';
$sidebar 	=	sh_set($settings, 'archive_sidebar');
$layout 	=	sh_set($settings, 'archive_layout');
$title 		=	sh_set($settings, 'archive_heading');
$icon 		=	sh_set($settings, 'archive_title_icon');
$blog_style	=	sh_set($settings, 'archive_blog_style');
$inner_cls	=	(sh_set($settings, 'archive_sidebar'))? 'col-md-6' : 'col-md-4';
$ext 		= 	explode( ' ', $title, 2 );
?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="<?php echo $class;?>">
					<?php if( sh_set( $settings, 'archive_show_heading' ) == 1 ): ?>
					<div class="heading1">
						<h1><?php if( $icon ):?><i class="<?php echo $icon?>"></i><?php endif; ?> <strong><?php echo sh_set( $ext, '0' )?></strong> <?php echo sh_set( $ext, '1' )?> <?php echo get_the_time('F, Y');?></h1>
					</div>
					<?php endif; ?>
