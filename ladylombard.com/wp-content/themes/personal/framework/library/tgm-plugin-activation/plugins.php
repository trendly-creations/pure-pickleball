...
function my_theme_register_required_plugins()
{
		$plugins = array(
		array(
			'name'     				=> 'Blog Post Types',
			'slug'     				=> 'blog_post_types',
			'source'   				=> SH_FRW_DIR . 'library/tgm-plugin-activation/plugins/blog_post_types.zip',
			'required' 				=> true,
			'version' 				=> '1.0',
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
			'external_url' 			=> 'http://themeforest.net/user/webinane',
			'file_path'				=>  ABSPATH.'wp-content/plugins/js_composer/blog_post_types.php'
		),
		array(
			'name'     				=> 'Blog ShortCodes',
			'slug'     				=> 'blog_shortcodes',
			'source'   				=> SH_FRW_DIR . 'library/tgm-plugin-activation/plugins/blog_shortcodes.zip',
			'required' 				=> true,
			'version' 				=> '1.0',
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
			'external_url' 			=> 'http://themeforest.net/user/webinane',
			'file_path'				=>  ABSPATH.'wp-content/plugins/js_composer/blog_shortcodes.php'
		),
		array(
			'name'     				=> 'Visual Composer',
			'slug'     				=> 'js_composer',
			'source'   				=> SH_FRW_DIR . 'library/tgm-plugin-activation/plugins/js_composer.zip',
			'required' 				=> true,
			'version' 				=> '4.0',
		...
		array(
			...
			'slug'     				=> 'revslider',
			'source'   				=> SH_FRW_DIR . 'library/tgm-plugin-activation/plugins/revslider.zip',
			'required' 				=> true,
			'version' 				=> '4.2.2',
			'force_activation' 		=> false,
			'force_deactivation' 	=> false,
