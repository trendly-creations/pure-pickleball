<?php
class MGS_Jollyanytheme_Block_Catalog_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price 
{
	...
	*/
	public function __construct(){
		...
		$this->_imagePath = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).'jollyany/slider/';
	...
	*/
	public function getSliderStatus(){
		if(Mage::getStoreConfig('jollyanytheme/catalog/price_slider'))
			return true;
		else
			return false;			
	}
	...
	*/
	...
	public function getPriceDisplayType(){
		$html = '<p class="label-box">'. $this->__('Price') .'
