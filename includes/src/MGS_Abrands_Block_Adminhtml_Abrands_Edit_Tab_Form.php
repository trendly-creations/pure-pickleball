...
{	
  ...
  protected function _prepareForm()
  {
      ...
      $fieldset = $form->addFieldset('abrands_form', array('legend'=>Mage::helper('abrands')->__('Item information')));
		...
		$attribute11 = Mage::getModel('eav/entity_attribute')
			->getCollection()->addFieldToFilter('attribute_code', Mage::getStoreConfig('jollyanytheme/general/brands'));
			
		$code= array ();
		foreach ($attribute11 as $item) {
